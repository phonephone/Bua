...
//        }))
        ...
        actionSheet.actions.last?.titleTextColor = .red
    ...
    func addAlertForSettings(_ attachmentTypeEnum: AttachmentType){
        ...
        if attachmentTypeEnum == AttachmentType.camera{
            alertTitle = CameraConstants.alertForCameraAccessMessage
        }
        if attachmentTypeEnum == AttachmentType.photoLibrary{
            alertTitle = CameraConstants.alertForPhotoLibraryMessage
        }
        if attachmentTypeEnum == AttachmentType.video{
            alertTitle = CameraConstants.alertForVideoLibraryMessage
        }
