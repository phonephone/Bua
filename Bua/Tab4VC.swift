...
class Tab4VC: UIViewController, WKNavigationDelegate {
    ...
    override func viewDidLoad() {
        ...
        webUrlString = Constants.GlobalVariables.mainJSON?["link_menu"]["menu4"].stringValue
        print("TAB4 = \(String(describing: webUrlString))")
