...
class Tab2VC: UIViewController, WKNavigationDelegate {
    ...
    override func viewDidLoad() {
        ...
        webUrlString = Constants.GlobalVariables.mainJSON?["link_menu"]["menu2"].stringValue
        print("TAB2 = \(String(describing: webUrlString))")
